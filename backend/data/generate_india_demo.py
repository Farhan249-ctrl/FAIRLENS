"""
[INDIA-SPECIFIC ANGLE] Generate 600-row synthetic Indian loan dataset
with deliberately embedded gender, caste, and religion bias.
This is your demo dataset — bias is real and detectable.
"""
import pandas as pd
import numpy as np
...
# ── BASE PROBABILITY (legitimate financial factors) ──────────────────
base = (
